...
class LocalizationManager: ObservableObject {
    ...
    private let translations: [String: [String: String]] = [
        "en": [
            ...
            "No past plans yet": "No past plans yet",
            "Shopping History": "Shopping History",
            "Enter brand manually...": "Enter brand manually...",
            "Or enter your own brand...": "Or enter your own brand...",
            "Select items": "Select items",
            "Item Skipped - Tap to Undo": "Item Skipped - Tap to Undo",
            "Skip this item (Generic)": "Skip this item (Generic)",
            "item(s)": "item(s)",
            ...
            "e.g., My Family, Roommates": "e.g., My Family, Roommates",
            "Create a group to share shopping lists with family and friends": "Create a group to share shopping lists with family and friends",
            "Invite Code": "Invite Code",
            "6-digit code": "6-digit code",
            "Enter the 6-digit invite code shared by a group member": "Enter the 6-digit invite code shared by a group member",
            ...
            "Create or join a group to start sharing shopping lists": "Create or join a group to start sharing shopping lists",
            "No Items Yet": "No Items Yet",
            "Add items to start your family shopping list": "Add items to start your family shopping list",
            "purchased": "purchased",
            "Total Estimate": "Total Estimate",
            "selected": "selected",
            "Failed to load items": "Failed to load items",
            "Added by": "Added by",
            "Change Brand/Deal": "Change Brand/Deal",
            "Item Details": "Item Details",
            "Quantity": "Quantity",
            "Notes (optional)": "Notes (optional)",
            "Edit Item": "Edit Item",
            "Add Items to Family List": "Add Items to Family List",
            "Search e.g. 'milk'": "Search e.g. 'milk'",
            "Add to Family List": "Add to Family List",
            "Enter a name for your new list": "Enter a name for your new list",
            "No shopping lists yet": "No shopping lists yet",
            "Create a list to start planning your shopping": "Create a list to start planning your shopping",
            "items needed": "items needed",
            "All items purchased": "All items purchased",
            "Create": "Create",
            "Join": "Join",
            "ADMIN": "ADMIN",
            "MEMBER": "MEMBER",
            "No deals found or failed to load": "No deals found or failed to load",
            "Copy": "Copy",
        ...
        "az": [
            ...
            "Group": "Qrup",
            "Group Shopping": "Qrupla Alış-veriş",
            "No past plans yet": "Keçmiş plan yoxdur",
            "Shopping History": "Alış-veriş tarixçəsi",
            "Enter brand manually...": "Brendi əllə daxil edin...",
            "Or enter your own brand...": "Yaxud öz brendinizi daxil edin...",
            "Select items": "Məhsulları seçin",
            "Item Skipped - Tap to Undo": "Məhsul Ötürüldü - Qaytarmaq üçün Toxunun",
            "Skip this item (Generic)": "Bu məhsulu keç (Ümumi)",
            "item(s)": "məhsul",
            
            // Family Flow
            "Create Group": "Qrup Yarat",
            "Join with Code": "Kod ilə Qoşul",
            "Group Name": "Qrup Adı",
            "e.g., My Family, Roommates": "məs., Ailəm, Otaq yoldaşları",
            "Create a group to share shopping lists with family and friends": "Ailə və dostlarınızla alış-veriş siyahılarını paylaşmaq üçün qrup yaradın",
            "Invite Code": "Dəvət Kodu",
            "6-digit code": "6-rəqəmli kod",
            "Enter the 6-digit invite code shared by a group member": "Qrup üzvünün paylaşdığı 6-rəqəmli dəvət kodunu daxil edin",
            "Join Group": "Qrupa Qoşul",
            "Are you sure you want to leave": "Tərk etməyinizə əminsiniz",
            "Shopping Lists": "Alış-veriş Siyahıları",
            "Leave Group": "Qrupu Tərk et",
            "Leave Group?": "Qrupu Tərk et?",
            "No Groups Yet": "Heç Bir Qrup Yoxdur",
            "Create or join a group to start sharing shopping lists": "Alış-veriş siyahılarını paylaşmağa başlamaq üçün qrup yaradın və ya qoşulun",
            "No Items Yet": "Heç Bir Məhsul Yoxdur",
            "Add items to start your family shopping list": "Ailə alış-veriş siyahınıza başlamaq üçün məhsullar əlavə edin",
            "pending": "gözlənilir",
            "purchased": "alınıb",
            "Total Estimate": "Ümumi Təxmini",
            "selected": "seçilib",
            "Failed to load items": "Məhsulları yükləmək alınmadı",
            "Added by": "Əlavə edən",
            "Change Brand/Deal": "Brendi/Fürsəti Dəyiş",
            "Quantity": "Miqdar",
            "Notes (optional)": "Qeydlər (istəyə bağlı)",
            "Edit Item": "Məhsulu Redaktə et",
            "Add Items to Family List": "Ailə Siyahısına Məhsullar Əlavə Et",
            "Search e.g. 'milk'": "Axtar məs. 'süd'",
            "Select the best deals for your items": "Məhsullarınız üçün ən yaxşı fürsətləri seçin",
            "Add to Family List": "Ailə Siyahısına Əlavə Et",
            "deal(s) selected": "fürsət seçildi",
            "Delete Selected": "Seçilmişləri Sil",
            "New Shopping List": "Yeni Alış-veriş Siyahısı",
            "List Name": "Siyahı Adı",
            "Enter a name for your new list": "Yeni siyahınız üçün ad daxil edin",
            "Create a list to start planning your shopping": "Alış-verişinizi planlamağa başlamaq üçün siyahı yaradın",
            "items needed": "məhsul lazımdır",
            "All items purchased": "Bütün məhsullar alındı",
            "Create": "Yarat",
            "Join": "Qoşul",
            "ADMIN": "İDARƏÇİ",
            "MEMBER": "ÜZV",
            "No deals found or failed to load": "Təklif tapılmadı və ya yükləmək mümkün olmadı",
            "Copy": "Kopyala",
            "Create New List": "Yeni Siyahı Yarat",
            "No shopping lists yet": "Hələ alış-veriş siyahısı yoxdur",
            "Add items": "Məhsullar əlavə et",
            "Add Items": "Məhsullar əlavə et",
            "Find Deals": "Təklifləri Tap"
        ]
    ]
}
